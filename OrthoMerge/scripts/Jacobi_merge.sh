...
python merge/Jacobi_merge.py \
  ...
  --fisher_paths \
      ../data/diagonal_fishers/llama3.1/llama3-1_8b_finetune_magicoder.safetensors \
      ../data/diagonal_fishers/llama3.1/llama3-1_8b_finetune_numinamath.safetensors \
      ../data/diagonal_fishers/llama3.1/llama3-1_8b_finetune_commonsense.safetensors \
      ../data/diagonal_fishers/llama3.1/llama3-1_8b_finetune_socialiqa.safetensors \
      ../data/diagonal_fishers/llama3.1/llama3-1_8b_finetune_scienceqa.safetensors \
